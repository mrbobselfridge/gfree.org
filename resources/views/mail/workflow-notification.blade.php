@php
    ...
    $preSnapshotUrl = (! $isCreateTrigger && ! $isDeleteTrigger && $event->pre_snapshot_path) ? $snapshotService->imageUrl($event->pre_snapshot_path) : null;
...
@if ($hasBothSnapshots || $singleSnapshotUrl)
    <hr>
