...
<head>
    ...
    <title>{{ $ministry->name }} | {{ $settings?->church_name ?? config('app.name', 'TwyxtCo Church') }}</title>
    <meta name="description" content="{{ $ministry->short_summary ?: 'Ministry at TwyxtCo Church.' }}">
