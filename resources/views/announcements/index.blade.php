...
<head>
    ...
    <title>Announcements | {{ $settings?->church_name ?? config('app.name', 'TwyxtCo Church') }}</title>
    <meta name="description" content="Current announcements and updates from TwyxtCo Church.">
...
<body class="site-page concept-page concept-page--editorial concept-page--editorial-white-header concept-page--accent-color-bands">
    ...
    <main>
        ...
        <section class="announcement-index">
            <x-listing-search :search="$search" placeholder="Search announcements" />
            ...
            @else
                <div class="page-content">
                    <p>{{ filled($search) ? 'No announcements match your search.' : 'There are no current announcements.' }}</p>
                </div>
            @endif
        </section>
    </main>
