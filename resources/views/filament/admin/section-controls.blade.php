<x-dynamic-component :component="$getFieldWrapperView()" :field="$field">
    <div
        ...
        style="padding-top:32px; align-items: center; display: flex; font-size: 1.25rem; font-weight: 800; height: 100%; justify-content: flex-end; line-height: 1.5rem; min-height: 2.5rem; text-align: right; width: 100%;"
