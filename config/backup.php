...
return [
    ...
    'backup' => [
         ...
         * the backups.
         */
        'name' => env('BACKUP_FULL_NAME', env('APP_NAME', 'gfree-site').'-full'),
        ...
        'source' => [
            'files' => [
                ...
                'include' => [
                    ...
                    storage_path('app/private/file-library'),
                ],
    ...
    'monitor_backups' => [
        [
            'name' => env('BACKUP_DATABASE_NAME', env('APP_NAME', 'gfree-site').'-database'),
            'disks' => array_values(array_filter(explode(',', env('BACKUP_DISKS', 'backups')))),
            'health_checks' => [
        ...
        [
            'name' => env('BACKUP_ARCHIVE_NAME', env('APP_NAME', 'gfree-site').'-archive'),
            'disks' => array_values(array_filter(explode(',', env('BACKUP_DISKS', 'backups')))),
            'health_checks' => [
    ...
    'cleanup' => [
        ...
        'default_strategy' => [
             ...
             */
            'delete_oldest_backups_when_using_more_megabytes_than' => (int) env('BACKUP_DELETE_OLDEST_WHEN_USING_MORE_MB', 20480),
        ],
